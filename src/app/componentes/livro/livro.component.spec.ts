...
describe('LivroComponent', () => {
  ...
  it('item deve componente de livro com sucesso', () => {
    expect(component).toBeTruthy()
  })

  it('deve renderizar as informações de título e autoria do livro', () => {
  ...
  it('deve exibir a imagem correta do livro', () => {
    const compiled = fixture.nativeElement
  ...
  it('deve formatar a data corretamente', () => {
    ...
    const resultado = pipe.transform(data, 'dd/MM/yyy')
    expect(resultado).toBe('19/04/2024')
  })

  it('deve retornar null para data nula', () => {
    const resultado = pipe.transform(null, 'dd/MM/yyy')
